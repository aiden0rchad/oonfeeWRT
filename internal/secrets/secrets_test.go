...
func TestMalformedKeyringIsRejected(t *testing.T) {
	for _, tc := range []struct {
		...
		{"excessive time", `{"version":1,"kdf":"argon2id","params":{"time":7,"memory_kib":64,"threads":1},"salt":"AAAA","wrapped_key":"AAAA"}`},
		{"zero threads", `{"version":1,"kdf":"argon2id","params":{"time":1,"memory_kib":64,"threads":0},"salt":"AAAA","wrapped_key":"AAAA"}`},
		{"excessive threads", `{"version":1,"kdf":"argon2id","params":{"time":1,"memory_kib":128,"threads":9},"salt":"AAAA","wrapped_key":"AAAA"}`},
		{"excessive memory", `{"version":1,"kdf":"argon2id","params":{"time":1,"memory_kib":131073,"threads":1},"salt":"AAAA","wrapped_key":"AAAA"}`},
