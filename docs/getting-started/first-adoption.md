...
<DocScreenshot
  src="adoption-overview" :width="1600" :height="1000"
...
A generic single-interface LAN is separate from legacy `swconfig`. v0.1.7
...
In v0.1.7, find **Install the oonfeeWRT
...
<DocScreenshot
  src="adoption-access" :width="1600" :height="1000"
