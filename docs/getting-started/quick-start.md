...
move **Adopt a device** into the primary group, and place **Settings** and
**Logs** in a **Controller** group at the foot of the sidebar. The group remains
reachable by scrolling on a short screen.
