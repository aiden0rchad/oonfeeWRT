...
oonfeeWRT v0.1.8 separates observation, controller desired state, and router
...
<span id="optional-actions-retained-in-v0-1-7"></span>

### Optional actions retained in v0.1.8

These actions were introduced in v0.1.6 and are retained in v0.1.8.
...
In v0.1.8, restore separately pauses external webhook delivery, cancels
...
- The controller has no native TLS listener in v0.1.8. Use loopback or a
...
- The Phase 5 flow-visibility document is a feasibility plan. v0.1.8 installs
