...
export default defineConfig({
  ...
  description: 'Documentation for oonfeeWRT v0.1.7: install, monitor, configure, operate, and understand the OpenWrt controller.',
  base: '/oonfeeWRT/',
  cleanUrls: true,
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'oonfeeWRT v0.1.7 Documentation' }],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Reference', link: '/reference/requirements' },
      {
        ...
        items: [
          { text: 'Release notes', link: '/reference/releases' },
          { text: 'Download v0.1.7', link: 'https://github.com/aiden0rchad/oonfeeWRT/releases/tag/v0.1.7' },
        ],
      },
    ],
    sidebar: [
